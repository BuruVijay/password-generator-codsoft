...
#title
heading = Label(root,text="Password Generator",bg="lightblue",fg="green",font="areal 20")
...
def spin():
    ...
    def click():
            ...
            button1=Button(root,text="poor",font="areal 8",bg="lightpink",fg="black",padx=15,pady=5,command=callback1)
            ...
            button3=Button(root,text="Advanced",font="areal 8",bg="yellow",fg="black",padx=15,pady=5,command=callback3)
